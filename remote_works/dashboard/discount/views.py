...
def get_voucher_type_forms(voucher, data):
    ...
    return {
        ...
        VoucherType.TYPE: forms.SkillVoucherForm(
            data or None, instance=voucher, prefix=VoucherType.TYPE),
...
def sale_list(request):
    sales = Sale.objects.prefetch_related('skills').order_by('name')
...
def voucher_list(request):
    vouchers = (Voucher.objects.prefetch_related('skills', 'collections')
                .order_by('name'))
