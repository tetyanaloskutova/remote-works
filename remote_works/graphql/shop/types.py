...
class Shop(graphene.ObjectType):
    ...
    charge_taxes_on_delivery = graphene.Boolean(
        description='Charge taxes on delivery', required=True)
    track_inventory_by_default = graphene.Boolean(
        description='Enable inventory tracking')
    default_weight_unit = WeightUnitsEnum(description='Default weight unit')
    translation = graphene.Field(
        ShopTranslation, language_code=graphene.String(
    ...
    def resolve_charge_taxes_on_delivery(self, info):
        return info.context.site.settings.charge_taxes_on_delivery
