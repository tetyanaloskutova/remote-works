...
def attributes_to_hstore(attribute_value_input, attributes_queryset):
    ...
    for attribute in attribute_value_input:
        ...
        if attr_slug not in attributes_map:
            raise ValueError(
                'Attribute %r doesn\'t belong to given skill type.' % (
                    attr_slug,))
