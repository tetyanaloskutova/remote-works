    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('error', models.CharField(choices=[(remote_works.payment.TransactionError('incorrect_number'), 'incorrect_number'), (remote_works.payment.TransactionError('invalid_number'), 'invalid_number'), (remote_works.payment.TransactionError('incorrect_cvv'), 'incorrect_cvv'), (remote_works.payment.TransactionError('invalid_cvv'), 'invalid_cvv'), (remote_works.payment.TransactionError('incorrect_zip'), 'incorrect_zip'), (remote_works.payment.TransactionError('incorrect_address'), 'incorrect_address'), (remote_works.payment.TransactionError('invalid_expiry_date'), 'invalid_expiry_date'), (remote_works.payment.TransactionError('expired'), 'expired'), (remote_works.payment.TransactionError('processing_error'), 'processing_error'), (remote_works.payment.TransactionError('declined'), 'declined')], max_length=256, null=True)),
