...
ROOT_URLCONF = 'remote_works.urls'

WSGI_APPLICATION = 'remote_works.wsgi.application'
...
TASK_FROM_EMAIL = os.getenv('TASK_FROM_EMAIL', DEFAULT_FROM_EMAIL)
...
STATICFILES_DIRS = [
    ('assets', os.path.join(PROJECT_ROOT, 'remote_works', 'static', 'assets')),
    ('favicons', os.path.join(PROJECT_ROOT, 'remote_works', 'static', 'favicons')),
    ('images', os.path.join(PROJECT_ROOT, 'remote_works', 'static', 'images')),
    ('dashboard/images', os.path.join(
        PROJECT_ROOT, 'remote_works', 'static', 'dashboard', 'images'))]
STATICFILES_FINDERS = [
...
context_processors = [
    ...
    'remote_works.core.context_processors.default_currency',
    'remote_works.checkout.context_processors.cart_counter',
    'remote_works.core.context_processors.search_enabled',
    'remote_works.site.context_processors.site',
...
MIDDLEWARE = [
    ...
    'remote_works.core.middleware.discounts',
    'remote_works.core.middleware.google_analytics',
    'remote_works.core.middleware.country',
    'remote_works.core.middleware.currency',
    'remote_works.core.middleware.site',
    'remote_works.core.middleware.taxes',
    'social_django.middleware.SocialAuthExceptionMiddleware',
    'impersonate.middleware.ImpersonateMiddleware',
    'remote_works.graphql.middleware.jwt_middleware'
]
...
INSTALLED_APPS = [
    ...
    # Local apps
    'remote_works.account',
    'remote_works.discount',
    'remote_works.skill',
    'remote_works.checkout',
    'remote_works.core',
    'remote_works.graphql',
    'remote_works.menu',
    'remote_works.task',
    'remote_works.dashboard',
    'remote_works.seo',
    'remote_works.delivery',
    'remote_works.search',
    'remote_works.site',
    'remote_works.data_feeds',
    'remote_works.page',
    'remote_works.payment',
...
bootstrap4 = {
    ...
    'success_css_class': '',
    'form_renderers': {
        'default': 'remote_works.core.utils.form_renderer.FormRenderer'}}
...
if AWS_MEDIA_BUCKET_NAME:
    DEFAULT_FILE_STORAGE = 'remote_works.core.storages.S3MediaStorage'
...
if ES_URL:
    SEARCH_BACKEND = 'remote_works.search.backends.elasticsearch'
...
AUTHENTICATION_BACKENDS = [
    'remote_works.account.backends.facebook.CustomFacebookOAuth2',
    'remote_works.account.backends.google.CustomGoogleOAuth2',
...
IMPERSONATE = {
    ...
    'CUSTOM_USER_QUERYSET': 'remote_works.account.impersonate.get_impersonatable_users',  # noqa
    'USE_HTTP_REFERER': True,
    'CUSTOM_ALLOW': 'remote_works.account.impersonate.can_impersonate'}
...
SERIALIZATION_MODULES = {
    'json': 'remote_works.core.utils.json_serializer'}
...
PAYMENT_GATEWAYS = {
    DUMMY: {
        'module': 'remote_works.payment.gateways.dummy',
        'connection_params': {}},
    BRAINTREE: {
        'module': 'remote_works.payment.gateways.braintree',
        'connection_params': {
    ...
    RAZORPAY: {
        'module': 'remote_works.payment.gateways.razorpay',
        'connection_params': {
    ...
    STRIPE: {
        'module': 'remote_works.payment.gateways.stripe',
        'connection_params': {
            ...
            'enable_delivery_address': os.environ.get(
                'STRIPE_ENABLE_DELIVERY_ADDRESS', False)
        }
    }
}
