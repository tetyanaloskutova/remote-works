...
export interface SaleDetailsFragment_categories_edges_node {
  ...
  id: string;
  name: string;
  products: SaleDetailsFragment_categories_edges_node_skills | null;
}
...
export interface SaleDetailsFragment_collections_edges_node {
  ...
  id: string;
  name: string;
  products: SaleDetailsFragment_collections_edges_node_skills | null;
}
...
export interface SaleDetailsFragment {
  ...
  endDate: any | null;
  value: number;
  products: SaleDetailsFragment_skills | null;
