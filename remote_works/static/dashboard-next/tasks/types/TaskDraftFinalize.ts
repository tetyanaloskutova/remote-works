...
export interface TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine_unitPrice_gross {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine_unitPrice_net {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine_unitPrice {
  __typename: "TaxedMoney";
  gross: TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine_unitPrice_gross;
  net: TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine_unitPrice_net;
}

export interface TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine {
  __typename: "TaskLine";
  id: string;
  ...
  unitPrice: TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine_unitPrice | null;
...
export interface TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines {
  ...
  id: string;
  quantity: number;
  taskLine: TaskDraftFinalize_draftTaskComplete_task_fulfillments_lines_taskLine | null;
}
