...
export interface TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine_unitPrice_gross {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine_unitPrice_net {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine_unitPrice {
  __typename: "TaxedMoney";
  gross: TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine_unitPrice_gross;
  net: TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine_unitPrice_net;
}

export interface TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine {
  __typename: "TaskLine";
  id: string;
  ...
  unitPrice: TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine_unitPrice | null;
...
export interface TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines {
  ...
  id: string;
  quantity: number;
  orderLine: TaskLineDelete_draftTaskLineDelete_task_fulfillments_lines_orderLine | null;
}
