...
export interface TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine_unitPrice_gross {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine_unitPrice_net {
  __typename: "Money";
  amount: number;
  currency: string;
}

export interface TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine_unitPrice {
  __typename: "TaxedMoney";
  gross: TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine_unitPrice_gross;
  net: TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine_unitPrice_net;
}

export interface TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine {
  __typename: "TaskLine";
  id: string;
  ...
  unitPrice: TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine_unitPrice | null;
...
export interface TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines {
  ...
  id: string;
  quantity: number;
  taskLine: TaskLinesAdd_draftTaskLinesCreate_task_fulfillments_lines_taskLine | null;
}
